...
4. Final art/trait source of truth:
   - `manifests/final_1000_manifest_v2.json`
...
3. `selected.json` is not the current source of truth.
   - Use `manifests/final_1000_manifest_v2.json` instead.
...
Use `manifests/final_1000_manifest_v2.json` as the base dataset.
...
Use:
1. `manifests/final_1000_manifest_v2.json`
...
2. Keep static collection viewer data generation from `final_1000_manifest_v2.json`
3. Refine `/collection`
4. Refine `/about`
