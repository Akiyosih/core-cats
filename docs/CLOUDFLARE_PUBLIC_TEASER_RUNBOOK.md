...
cache `viewer_v3` art assets, the white-background avatar PNGs, and the teaser images aggressively after each deploy.
...
10. `/viewer_v3/collection-index.json` loads from the static teaser origin.
11. image responses under `/viewer_v3/png/`, `/viewer_v3/png-white/`, and `/viewer_v3/svg/` return long-lived cache headers.
