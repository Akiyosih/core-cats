...
2. active beam selection: `manifests/superrare_beam_selection_v3.json`
3. active beam reorder: `manifests/beam_token_reorder_v3.json`
4. `manifests/trait_display_labels_v1.json`
5. active summary: `manifests/final_1000_trait_summary_v3.json`
...
`web/public/viewer_v3/svg/`

Generated files:
1. `collection.json`
   - UI-ready 1000 item dataset
   - includes `image_svg_src` pointing at static preview SVG files under `web/public/viewer_v3/svg/`
   - includes `image_preview_src` pointing at static preview PNG files under `web/public/viewer_v3/png/`
...
1. `web/public/viewer_v3/svg/*.svg`
   - one renderer-derived SVG preview per token
2. `web/public/viewer_v3/png/*.png`
...
3. It ports the current renderer logic into JS and verifies decoded traits against `final_1000_manifest_v3.json` before writing outputs.
...
Then compare:
1. `manifests/viewer_v3/collection.json`
2. `web/public/viewer_v3/svg/<tokenId>.svg`
3. `web/public/viewer_v3/png/<tokenId>.png`
4. `web/public/viewer_v3/png-white/<tokenId>.png`
