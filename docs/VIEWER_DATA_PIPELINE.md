...
4. This is the correct current path for `/collection`, `/about`, and `/transparency` foundation work while final mint randomness and quantity mint are still pending.
