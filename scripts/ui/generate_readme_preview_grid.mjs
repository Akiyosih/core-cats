...
const VIEWER_COLLECTION_PATH = path.join(CORE_CATS_ROOT, "manifests", "viewer_v3", "collection.json");
const PREVIEW_PNG_DIR = path.join(CORE_CATS_ROOT, "web", "public", "viewer_v3", "png");
const OUTPUTS = [
