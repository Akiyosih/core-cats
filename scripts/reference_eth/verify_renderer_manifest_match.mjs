...
async function main() {
  ...
  const manifestPath = path.join(root, "manifests", "final_1000_manifest.json");
  ...
  console.log("[verify-renderer] PASS: all 1000 token metadata attributes match final_1000_manifest.json");
