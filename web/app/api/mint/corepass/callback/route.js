...
import { completeCorePassCallback, readCallbackBody, resolveRedirectHandoffMode } from "./shared.js";
...
export async function GET(request) {
  ...
  try {
    ...
    return completeCorePassCallback(session?.sessionId || sessionId, "", session?.handoffMode || "");
  } catch (error) {
