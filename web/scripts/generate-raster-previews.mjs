...
const SVG_DIR = path.join(WEB_ROOT, "public", "viewer_v2", "svg");
const PNG_DIR = path.join(WEB_ROOT, "public", "viewer_v2", "png");
const PNG_WHITE_DIR = path.join(WEB_ROOT, "public", "viewer_v2", "png-white");
